namespace Fusion.Menu {
  ...
  public partial class FusionMenuUIMain : FusionMenuUIScreen {
    ...
    /// <summary>
    /// The open start screen button.
    /// </summary>
    [InlineHelp, SerializeField] protected UnityEngine.UI.Button _startButton;
    /// <summary>
    ...
    /// <summary>
    /// Is called when the <see cref="_startButton"/> is pressed using SendMessage() from the UI object.
    /// </summary>
    protected virtual void OnStartButtonPressed() {
      Controller.Show<FusionMenuUIStart>();
    }
